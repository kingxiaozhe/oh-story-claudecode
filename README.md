...
```
安装这个 skill https://github.com/kingxiaozhe/oh-story-claudecode
```
...
>
> 升级后如果项目里已经跑过 `/story-setup`，建议在项目根重跑一次 `/story-setup`，同步 hooks / agents / references。每版变更见 [CHANGELOG.md](CHANGELOG.md) 与 [Releases](https://github.com/kingxiaozhe/oh-story-claudecode/releases)。
...
- **GitHub Discussions**：[提问 / 求助 / 分享用法](https://github.com/kingxiaozhe/oh-story-claudecode/discussions)，方便检索。
